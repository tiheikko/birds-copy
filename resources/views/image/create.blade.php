...
@section('admin_main_content')
	...
	<form class="create_image" action="{{ route('image.store') }}" method="post" enctype="multipart/form-data" id="new_img_bird">
		@csrf
        ...
        <input type="file" id="upload_new_img" name="img" accept="image/*">
